...
@Component({
  selector: 'app-page-builder-and-test',
  imports: [ CommonModule, AboutTheAuthorComponent, MatButtonModule, SkeletonLoaderComponent, RouterModule ],
  templateUrl: './page-builder-and-test.component.html',
  styleUrl: './page-builder-and-test.component.scss'
})
export class PageBuilderAndTestComponent implements OnInit {
  slug: string = '';
  content: SafeHtml = '';
